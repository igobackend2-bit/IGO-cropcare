...
const FLASH_DEALS = [
  { id: 'ch-f-002', name: 'Chemica DAP 50kg (Di-Ammonium Phosphate)', brand: 'Chemica', category: 'Fertilizer', price: 1350, mrp: 1500, discount: 10, rating: 4.8, reviews: 3892, badge: 'Hot Deal', stock: 'In Stock', image: '/products/Products/Chemical Fertilizers/DAP (Di-Ammonium Phosphate).png', href: '/products/ch-f-002' },
  { id: 'ch-f-003', name: 'Chemica Ammonium Nitrate (34% N)', brand: 'Chemica', category: 'Fertilizer', price: 580, mrp: 750, discount: 23, rating: 4.6, reviews: 876, badge: 'Fast Acting', stock: 'In Stock', image: '/products/Products/Chemical Fertilizers/Ammonium Nitrate.png', href: '/products/ch-f-003' },
  { id: 'ch-f-005', name: 'Chemica CAN (Calcium Ammonium Nitrate)', brand: 'Chemica', category: 'Fertilizer', price: 680, mrp: 880, discount: 23, rating: 4.7, reviews: 654, badge: 'Greenhouse Pick', stock: 'In Stock', image: '/products/Products/Chemical Fertilizers/Calcium Ammonium Nitrate (CAN).png', href: '/products/ch-f-005' },
  { id: 'ch-o-001', name: 'Chemica Bio Compost (Enriched)', brand: 'Chemica', category: 'Organic', price: 299, mrp: 399, discount: 25, rating: 4.8, reviews: 1456, badge: 'Organic', stock: 'In Stock', image: '/products/Products/Organic Fertilizers/Bio Composer.png', href: '/products/ch-o-001' },
  { id: 'ch-o-002', name: 'Chemica Coco Peat Block 5kg', brand: 'Chemica', category: 'Organic', price: 180, mrp: 249, discount: 28, rating: 4.9, reviews: 2310, badge: 'Nursery Pick', stock: 'In Stock', image: '/products/Products/Organic Fertilizers/CoCo Peat.png', href: '/products/ch-o-002' },
  { id: 'ch-s-001', name: 'Chemica Paddy Seeds (Hybrid Short Duration)', brand: 'Chemica', category: 'Seeds', price: 580, mrp: 720, discount: 19, rating: 4.8, reviews: 2876, badge: 'High Yield', stock: 'In Stock', image: '/products/Products/Field Seeds/Paddy.png', href: '/products/ch-s-001' },
];
